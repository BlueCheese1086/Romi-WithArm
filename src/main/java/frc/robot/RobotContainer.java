...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(xboxController, Button.kX.value).whileTrue(new WristUp(arm));
    new JoystickButton(xboxController, Button.kY.value).whileTrue(new WristDown(arm));
    new JoystickButton(xboxController, Button.kA.value).whileTrue(new GripperOpen(arm));
    new JoystickButton(xboxController, Button.kB.value).whileTrue(new GripperClose(arm));
  }
